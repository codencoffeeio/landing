...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: 'meta-muse-code-ai-coding-agent-review',
    title: "Meta Just Launched a Coding Agent. It's Cheap — But Read the Fine Print.",
    subtitle: "Muse Code is Meta's terminal coding agent, and at $0.10 per million tokens it undercuts everyone. The catch: that price means your code trains their next model.",
    date: "August 14, 2026",
    readTime: "6 min read",
    tags: ["AI Coding", "Meta", "Muse Code", "Developer Tools"],
    excerpt: "Meta entered the terminal coding agent race on August 5 with Muse Code — a direct rival to Claude Code, OpenAI Codex, and Cursor. It beats Codex on benchmarks, runs parallel agents in isolated worktrees, and offers a price that seems too good to be true. It is, sort of.",
    author: "Code, Coffee & AI",
    content: [
      { type: 'p', text: "Every major AI lab now has a terminal coding agent. OpenAI has Codex. Anthropic has Claude Code. Google has Gemini CLI. And as of August 5, Meta has Muse Code — a direct competitor built on Muse Spark 1.2, a coding-focused model released alongside the agent." },
      { type: 'p', text: "The pitch is straightforward: install it with one shell command, point it at your repo, and let it plan, write, and validate code autonomously across large codebases. The pricing, though, is where things get interesting — and where developers need to read carefully before they start typing." },
      { type: 'h2', text: "What Muse Code Actually Does" },
      { type: 'p', text: "Muse Code is a terminal-based agentic coding tool — same category as Claude Code and Codex CLI. You run it in your terminal, give it a task, and it plans the changes, writes the code, and validates the results. It can handle full software engineering tasks across large repos, not just single-file edits." },
      { type: 'p', text: "The standout technical detail is how it handles parallel work. Muse Code spawns sub-agents into isolated git worktrees — similar to how Cursor 3 runs parallel agents — so it can work on multiple independent tasks simultaneously without file conflicts. It also ships with a crash-safe event log, which means if a session dies mid-task, it can resume from where it left off rather than starting over." },
      {
        type: 'list',
        items: [
      ...
      { type: 'h2', text: "How It Performs" },
      { type: 'p', text: "Benchmark results put Muse Code in a clear middle position: ahead of Codex, behind Claude Code on Opus 5." },
      { type: 'p', text: "On Terminal-Bench 2.1, Muse Spark 1.2 scored 82.9% — ahead of GPT-5.6 Terra on Codex at 81.8%, but behind Claude Code on Opus 5 at 86.7%. On DeepSWE 1.1, Muse scored 59.3% versus 65.0% for Opus 5 and 64.8% for Codex. Even on Meta's own internal benchmark, Claude Code beat Muse by 8.8 points." },
      { type: 'p', text: "To be clear: these are good numbers. Muse Code is genuinely competitive. It's not the best terminal coding agent available, but it's in the conversation — and for many tasks, second-best at a fraction of the price is a perfectly reasonable trade." },
      { type: 'h2', text: "The Pricing Model — and the Catch" },
      { type: 'p', text: "This is where Muse Code gets genuinely interesting, and where developers need to pay attention." },
      { type: 'p', text: "Muse Code has two pricing tiers:" },
      {
        type: 'list',
        items: [
      ...
      { type: 'p', text: "That's a 21x price difference. And here's the critical detail: Muse Code defaults to the Contributor tier after install. You have to actively switch to Standard to opt out of data collection — and the setting lives in pricing configuration, not in an obvious onboarding prompt." },
      { type: 'callout', title: "Watch the default", text: "Security researchers and enterprise teams have flagged that the Contributor tier is selected by a model ID, not a signed agreement, and early testers often miss the setting during initial trials. If you're working with proprietary codebases, check your tier immediately after install. Your code is leaving the building by default." },
      { type: 'p', text: "For solo developers and open source projects, the Contributor tier might be a perfectly acceptable trade — $0.10 per million tokens for a capable coding agent is genuinely cheap, and contributing to model improvement is a reasonable exchange if you're not shipping proprietary code." },
      { type: 'p', text: "For enterprise teams, agencies, or anyone working with client code or sensitive IP: use Standard, set it explicitly in your configuration, and make sure anyone trialling the tool knows to do the same." },
      { type: 'h2', text: "How It Compares to Claude Code and Codex" },
      { type: 'p', text: "The honest comparison: Muse Code sits between Codex and Claude Code on raw capability, and undercuts both on price — even at Standard rates. The worktree-based parallel agent design is genuinely well-engineered, and the crash-safe resume is a practical detail that matters for long-running tasks." },
      { type: 'p', text: "Where Claude Code still leads: benchmark performance, ecosystem depth, and trust — particularly important in agentic contexts where the model is making decisions autonomously. Where Muse Code wins: price, and the $0.10 Contributor tier for non-sensitive work." },
      { type: 'p', text: "The interesting dynamic is that Meta releasing a capable, cheap competitor accelerates the whole category. OpenAI has already cut GPT-5.6 prices up to 80% in the same period. The terminal coding agent market is getting more competitive fast, and that's good for developers." },
      { type: 'h2', text: "Worth Trying?" },
      { type: 'p', text: "Yes — with the caveat. Muse Code is a genuinely solid agentic coding tool, and at Standard pricing it's competitive. The Contributor tier is an attractive option for personal or open-source projects if you're comfortable with the data trade. Just make sure you know which tier you're on before you start." },
      { type: 'p', text: "The terminal coding agent race now has five serious competitors: Claude Code, Codex, Cursor, Grok Build, and Muse Code. Trying a few of them on your actual workflow — not benchmarks — is the fastest way to figure out which one actually works for how you code." },
      {
        type: 'sources',
        items: [
          { title: "TechCrunch — Meta launches Muse Code, an AI agent for large code bases", url: "https://techcrunch.com/2026/08/05/meta-launches-muse-code-an-ai-agent-for-large-code-bases/" },
          { title: "VentureBeat — Meta enters the AI coding wars with Muse Spark 1.2", url: "https://venturebeat.com/orchestration/meta-enters-the-ai-coding-wars-with-muse-spark-1-2-and-muse-code-with-persistent-async-background-agents" },
          { title: "Decrypt — Meta Debuts AI Coding Agent Muse: How It Compares to Claude Code and Codex", url: "https://decrypt.co/375001/muse-code-meta-ai-coding-agent-claude-codex" },
          { title: "Cryptopolitan — Meta's Muse Code beats Codex but trails Claude Opus 5 on benchmarks", url: "https://www.cryptopolitan.com/meta-muse-code-beats-codex-trails-opus-5/" },
          { title: "The New Stack — Meta's new coding agent is cheap (but it'll cost you your data)", url: "https://thenewstack.io/meta-muse-code/" },
          { title: "Codersera — Muse Code Contributor Tier: What 21x Cheaper Actually Costs You", url: "https://codersera.com/blog/muse-code-contributor-tier-privacy-2026/" },
          { title: "DevX — Muse Code Default Sends Data to Meta", url: "https://www.devx.com/daily-news/muse-code-default-sends-data-to-meta/" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'sources', items: [
        { title: "A Framework for Frontier AI and the Dawning of a New Age — Demis Hassabis (Substack)", url: "https://demishassabis.substack.com/p/a-framework-for-frontier-ai-and-the-dawning-of-a-new-age" },
        { title: "Google's Hassabis calls for new US-led global AI watchdog 'before year end' — Axios", url: "https://www.axios.com/2026/07/14/demis-hassabis-ai-regulation-google-deepmind" },
        ...
        { title: "Google DeepMind CEO Wants an AI Watchdog That Could Pause the Entire Industry — TechTimes", url: "https://www.techtimes.com/articles/320558/20260715/google-deepmind-ceo-wants-ai-watchdog-that-could-pause-entire-industry.htm" },
        { title: "Behind the Curtain: AI godfathers converge on regulations — Axios", url: "https://www.axios.com/2026/07/16/ai-regulations-openai-anthropic-google" },
        { title: "Google DeepMind's Co-Founder Wants a Wall Street-Style Watchdog to Stop Dangerous AI — Inc.", url: "https://www.inc.com/georgia-fearn/google-deepmind-founder-wall-street-style-watchdog-stop-dangerous-ai/91373798" },
      ]},
    ],
  },
  {
